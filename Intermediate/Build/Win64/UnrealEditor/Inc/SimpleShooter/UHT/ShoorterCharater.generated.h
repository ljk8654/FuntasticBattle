...
#define FID_FuntasticBattle_Source_SimpleShooter_ShoorterCharater_h_26_RPC_WRAPPERS_NO_PURE_DECLS \
...
#define FID_FuntasticBattle_Source_SimpleShooter_ShoorterCharater_h_26_INCLASS_NO_PURE_DECLS \
private: \
...
#define FID_FuntasticBattle_Source_SimpleShooter_ShoorterCharater_h_26_ENHANCED_CONSTRUCTORS \
private: \
...
#define FID_FuntasticBattle_Source_SimpleShooter_ShoorterCharater_h_23_PROLOG
#define FID_FuntasticBattle_Source_SimpleShooter_ShoorterCharater_h_26_GENERATED_BODY \
PRAGMA_DISABLE_DEPRECATION_WARNINGS \
public: \
	FID_FuntasticBattle_Source_SimpleShooter_ShoorterCharater_h_26_RPC_WRAPPERS_NO_PURE_DECLS \
	FID_FuntasticBattle_Source_SimpleShooter_ShoorterCharater_h_26_INCLASS_NO_PURE_DECLS \
	FID_FuntasticBattle_Source_SimpleShooter_ShoorterCharater_h_26_ENHANCED_CONSTRUCTORS \
private: \
...
#define FOREACH_ENUM_ECHARSTATE(op) \
	op(ECharState::Normal) \
	op(ECharState::Hit) \
	op(ECharState::Stunned) \
	op(ECharState::Recover) 

enum class ECharState : uint8;
template<> struct TIsUEnumClass<ECharState> { enum { Value = true }; };
